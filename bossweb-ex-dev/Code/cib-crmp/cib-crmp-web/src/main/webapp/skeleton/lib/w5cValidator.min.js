        ...
        var validatorFn = function () {
            ...
            this.defaultShowError = function (elem, errorMessages) {
                ...
                if (!this.isEmpty($group) && !$group.hasClass("has-error")) {
                	if(typeof(errorMessages[0])!='undefined'){
...
//                		{return document.getElementById("productInfo").childNodes.length;}, function(value){
//                			alert("updated.");
//                });
                ...
                if (attr.w5cSubmit && angular.isFunction(formSubmitFn)) {
                    ...
                    form.bind("submit", function () {
                        doValidate();
                        if (scope[formName].$errors.length == 0 && angular.isFunction(formSubmitFn)) {
                            scope.$apply(function () {
                                formSubmitFn(scope);
                            });
                        }
