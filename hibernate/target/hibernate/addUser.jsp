...
<form action="/hib/addUser.action" method="post" onsubmit="">
    <fieldset>
        ...
        <p>*性别:
            <input type="radio" value="1" name="u.info.sex">男
            <input type="radio" value="0" name="u.info.sex">女
        </p>
        <p>*年龄:<input type="text" name="u.info.age" ></p>
        <p>备注:<textarea name="info.mess">请填写备注...可选填</textarea></p>
        <p>请选择部门:
