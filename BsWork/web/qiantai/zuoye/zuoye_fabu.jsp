...
<html>
  ...
  <BODY background="../img/beiji.png" text=#000000  leftMargin=0 topMargin=0>
	<div class="wrap"> 
					...
					<TD class=Side vAlign=top align=right width="75%">
						<TABLE class=dragTable cellSpacing=0 cellPadding=0 width="100%" border=0>
								...
								<TR align="left" height="500">
									<TD>
									    <form action="<%=path %>/zuoye?type=zuoye_fabu" name="formAdd" method="post">
