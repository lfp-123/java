...
<div class="lyear-layout-web">
    <div class="lyear-layout-container">
            ...
            <div class="lyear-layout-sidebar-scroll">
                ...
                <nav class="sidebar-main">
                    <ul class="nav nav-drawer">
                        <li class="nav-item active"> <a href="home.html"><i class="mdi mdi-home"></i> 首页</a> </li>
                        ...
                        <li class="nav-item nav-item-has-subnav">
                            ...
                            <ul class="nav nav-subnav">
                                <li> <a  href="javascript:void(0)" _href="admin/list.html">用户管理</a> </li>
                                <li> <a href="javascript:void(0)" _href="role/list.html">角色管理</a> </li>
                                <li> <a href="javascript:void(0)" _href="log/log.html">操作日志</a> </li>
        ...
        <main class="lyear-layout-content">
            <iframe src="index.html" id="main" frameborder="0" style="width: 100%;" ></iframe>
        </main>
        <!--End 页面主要内容-->
    </div>
</div>
